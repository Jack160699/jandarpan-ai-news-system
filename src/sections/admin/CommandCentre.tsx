...
const CACHE_KEY = "jd-admin-overview-daily-v1";
  ...
  return (
    <Av3Stack className="av3-owner">
      <section className="av3-owner-summary">
        <div className="av3-owner-summary__head">
          {platform ? (
            ...
            <Av3StatusBadge tone="unknown" label="Platform summary pending" />
          )}
      ...
      <Av3Panel title="Needs attention now" subtitle="Distinct owner actions">
        {data.incidents.length === 0 && !(data.editorial.awaitingReview ?? 0) ? (
