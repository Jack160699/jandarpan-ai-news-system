...
export default function NationalNewsLoading() {
  if (isReaderDesignSystemEnabled()) {
    return <LoadingSkeleton />;
  }

  return (
    <div className="route-loading route-loading--premium nr-wrap py-4" aria-busy="true" aria-label="Loading national news">
