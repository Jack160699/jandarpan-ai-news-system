...
export const articles: Record<string, Article> = {
  [HERO_ARTICLE_SLUG]: {
    ...
    filedFrom: "Filed from Raipur · Jan Darpan — India Investigations",
    readTime: "16 min",
    image: EDITORIAL_IMAGES.civicOffice,
    imageCredit: "Photograph · Jan Darpan — India Archive",
    ...
    paragraphs: [
      ...
      "Jan Darpan — India began reviewing the access logs after a tip that did not arrive on letterhead. What emerged was not a hacker drama but something more familiar: a sequence of permissions granted, revoked, and granted again within the same department.",
  ...
  "school-on-the-highway": {
    ...
    imageCredit: "Photograph · Jan Darpan — India",
    category: "Education",
    pullQuote:
