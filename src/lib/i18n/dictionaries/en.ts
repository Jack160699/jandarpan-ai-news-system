...
export const en: Dictionary = {
  ...
  home: {
    ...
    nationalNewsTab: "National News",
    internationalNewsTab: "International News",
    nationalSegmentEmpty: "No stories in this feed right now.",
    allUpdates: "All updates",
    districtWire: "District Wire",
    districtLive: "Live",
    districtLivePrefix: "LIVE",
    districtLiveStoriesLabel: "live stories",
  ...
  footer: {
    ...
    todayLive: {
      ...
      timezone: "IST",
      defaultBreaking:
        "Parliament monsoon session updates continue today",
      defaultLocal:
        "Heavy rainfall alert issued in Chhattisgarh districts",
    },
